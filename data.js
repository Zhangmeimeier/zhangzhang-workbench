...
const WBData = {
  ...
  diet: {
    ...
    calories: {
      ...
      海带: 13, 冬瓜: 12, 紫菜: 250,
      猪肉: 143, 鸡肉: 165, 面条: 110, 馒头: 223, 面包: 265,
      西瓜: 30, 橙子: 47, 葡萄: 43, 梨: 57, 花生: 567,
      核桃: 654,       植物油: 884, 土豆: 77, 米粥: 46
    }
  },
  ...
  inspiration: {
    topics: [
      ...
      "猫狗合租和平共处指南：从打架到贴贴",
      "第一次带宠物体检：医院避坑清单",
      "宠物去世/走丢后的情绪疗愈：如何好好告别",
      "捡到流浪猫怎么办？新手救助全流程",
      "宠物账号起号复盘：我第一个1万粉怎么来的",
      // —— 局宝专属选题（大体重金毛·老干部·摩羯座·旺仔控）——
      "局宝老干部晨间视察：这个家没我得散",
      "8岁摩羯座金毛的'周一厌世脸'",
      "大体重金毛上桌讨旺仔，铲屎官敢不给？",
      "局宝の下午茶：旺仔牛奶品鉴大会",
    ...
    hotRemix: [
      ...
      { title: "宠物经济爆发：养宠人都在为什么买单？", heat: 94, tag: "宠物" }
    ],
    review: ""
  },
  ...
  news: [
    ...
    { id: 7, title: "宠物短视频赛道升温：金毛、柯基等中大型犬内容流量看涨", category: "自媒体", heat: 89, time: "今天 14:20", content: "随着宠物经济升温，抖音、小红书等平台对真实、有性格的宠物日常内容流量扶持明显。具备稳定人设、系列化更新的宠物账号更容易出圈。" }
  ],
  ...
  moneyInfo: [
    ...
    { id: 6, title: "宠物账号接宠物食品广告", content: "粉丝过千可接狗粮、零食、牵引绳等置换；过5000可报价带货，佣金10%-30%不等。", source: "抖音", time: "2026-07-31", collected: false },
    { id: 7, title: "宠物直播打赏+橱窗带货", content: "固定时段直播局宝日常，挂宠物零食、玩具、日用品橱窗，赚佣金和打赏。", source: "抖音", time: "2026-07-31", collected: false },
    { id: 8, title: "定制宠物周边变现", content: "把局宝形象做成贴纸、手机壳、帆布袋、台历，在小红书/闲鱼预售。", source: "小红书", time: "2026-07-31", collected: false },
    { id: 9, title: "宠物短视频素材售卖", content: "高清、有创意的萌宠视频可上传视觉中国、新片场等素材平台，按下载量分成。", source: "B站", time: "2026-07-31", collected: false },
    { id: 10, title: "老年犬养护知识付费", content: "把8岁金毛喂养、体检、关节护理经验整理成电子书或社群答疑，199-399元/份。", source: "知乎", time: "2026-07-31", collected: false },
    { id: 11, title: "宠物账号多平台分发", content: "同一内容同步发抖音、小红书、视频号、B站，最大化流量和广告收入。", source: "自媒体", time: "2026-07-31", collected: false },
    { id: 12, title: "本地宠物约拍/摄影", content: "用局宝做样片，接同城宠物写真、生日跟拍，单价200-800元/组。", source: "闲鱼", time: "2026-07-31", collected: false },
    { id: 13, title: "宠物团购社群", content: "建宠物用品团购群，对接1688或代理货源，赚差价或分销佣金。", source: "微信", time: "2026-07-31", collected: false }
  ],
  ...
  blogs: [
    ...
    { id: 6, title: "狗狗抖音账号从0到1：人设+选题+变现全攻略", source: "运营研究社", category: "宠物自媒体", date: "2026-07-31", url: "#", collected: false }
  ],
